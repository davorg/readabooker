...
CREATE TABLE book (id integer primary key autoincrement, title text not null, author_id int not null, sort_title text not null, asin text not null, foreign key (author_id) references person(id));
